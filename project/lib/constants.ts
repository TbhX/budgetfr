...
export const REVENUE_CATEGORIES = [
  {
    id: 'tva',
    name: 'TVA',
    description: 'Taxe sur la Valeur Ajoutée - Principal impôt sur la consommation',
    defaultAmount: 92.4,
  },
  {
    id: 'ir',
    name: 'Impôt sur le revenu',
    description: 'Impôt progressif sur les revenus des ménages - Principal levier de redistribution',
    defaultAmount: 77.0,
  },
  {
    id: 'is',
    name: 'Impôt sur les sociétés',
    description: 'Impôt sur les bénéfices des entreprises - Contribution du monde économique',
    defaultAmount: 39.4,
  },
  {
    id: 'cotisations',
    name: 'Cotisations sociales',
    description: 'Contributions aux organismes sociaux - Financement de la protection sociale',
    defaultAmount: 251.3,
  },
  {
    id: 'autres',
    name: 'Autres recettes',
    description: "Autres sources de revenus de l'État (taxes spécifiques, revenus du domaine...)",
    defaultAmount: 52.8,
  },
] as const;
